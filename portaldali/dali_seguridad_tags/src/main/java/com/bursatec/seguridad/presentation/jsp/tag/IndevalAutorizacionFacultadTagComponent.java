...
public class IndevalAutorizacionFacultadTagComponent extends HtmlPanelGroup {
	...
	private boolean verificarFacultades() {
		...
		try {
			...
			log.error("Error al verificar facultades en el servicio de seguridad SeguridadException :", se);
			String mensajeError = "";
			...
			log.error("Error al verificar facultades en el servicio de seguridad Exception :", re);
			String mensajeError = "";
