 ...
 */
public class ITestEjecutaOperacionGarantias_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestEjecutaOperacionGarantias_1.class);
