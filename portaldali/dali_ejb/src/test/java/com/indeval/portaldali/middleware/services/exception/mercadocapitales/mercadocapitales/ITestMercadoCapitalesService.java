...
//    /**
//     * Metodo que prueba la consulta del folio operacion atraves de la invocacion de
//     * storedProcedureDao en el servicio de capitales.
//     * @throws Exception
//     */
//    public void testGetFolioOperacion() throws Exception {
//    	log.info("Entrando al metodo ITestMercadoCapitalesService" +
//    			".testGetFolioOperacion()");
//    	BigDecimal folioOperacion = mercadoCapitales.getFolioOperacion();
//    	assertNotNull(folioOperacion);
//
//	}
    
    /**
    * Metodo encargado de probar la excepcion del limite de la cantidad
    * @throws BusinessException
    */
   public void testEJBCapturaTraspasoCantidad() throws BusinessException {
       log.debug(":::::::::Entro al test de captura traspasos:::::::::::::::");
       GetCapturaTraspasoParams params = new GetCapturaTraspasoParams();
       GregorianCalendar fecha = new GregorianCalendar(1, 1, 1);
       fecha.set(2007, 3, 14);
       ...
       params.setTraspasante(traspasante);
       params.setReceptor(receptor);
       params.setAgenteFirmado(traspasante);
       params.setEmision(emision);
       params.setCantidad(new BigDecimal("99999999999999999.99999999"));
       params.setCveReporto("T");
       params.setDivisa(" ");
       params.setFecha(fecha.getTime());
       params.setFechaLiquidacion(fecha.getTime());
