 ...
 */
public class ITestAdministracionGarantias_e1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestAdministracionGarantias_e1.class);
