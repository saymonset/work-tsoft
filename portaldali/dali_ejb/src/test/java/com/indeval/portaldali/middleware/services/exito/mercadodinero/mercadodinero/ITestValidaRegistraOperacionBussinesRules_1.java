 ...
 */
public class ITestValidaRegistraOperacionBussinesRules_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestValidaRegistraOperacionBussinesRules_1.class);
