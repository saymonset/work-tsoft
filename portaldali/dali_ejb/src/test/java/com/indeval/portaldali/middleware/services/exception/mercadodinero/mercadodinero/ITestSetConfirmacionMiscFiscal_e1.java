 ...
 */
public class ITestSetConfirmacionMiscFiscal_e1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestSetConfirmacionMiscFiscal_e1.class);
    ...
    public void testSetConfirmacionMiscFiscal() throws Exception {
        ...
        Integer[] foliosConfirmados = mercadoDineroService
                .setConfirmacionMiscFiscal(agenteVO, folios);
