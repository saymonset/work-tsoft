 ...
 */
public class ITestConsultaMovimientosMiscFiscal_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestConsultaMovimientosMiscFiscal_1.class);
