 ...
 */
public class ITestGetInstituciones_e1 extends BaseITestService {
    ...
    /**
     * Prueba getInstituciones(GetEdoCtaLiqParams):List
     *
     * @throws BusinessException
     */
    public void testEJBGetInstituciones() throws BusinessException {

        log.debug("Entrando exitosa de testEJBGetInstituciones()");
        ...
        //TODO
//        List resultado = tesoreriaService.getInstituciones(params);
...
//        UtilsLog.logElementosLista(resultado, true);
        ...
        log.debug("Saliendo de testEJBGetInstituciones()");
