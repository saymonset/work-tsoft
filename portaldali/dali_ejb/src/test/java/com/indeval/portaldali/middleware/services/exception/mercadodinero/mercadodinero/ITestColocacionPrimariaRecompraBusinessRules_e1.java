 ...
 */
public class ITestColocacionPrimariaRecompraBusinessRules_e1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestColocacionPrimariaRecompraBusinessRules_e1.class);
     ...
     */
    public void testColocacionPrimariaRecompraBusinessRules() throws BusinessException {

        log.info("Entrando a ITestColocacionPrimariaRecompraBusinessRules_1.testColocacionPrimariaRecompraBusinessRules()");
       ...
       String folio = mercadoDineroService.validaGetColocacionPrimariaRecompraBusinessRules(params);
       assertNotNull(folio);
       log.debug("Folio Operacion: [" + folio + "]");
       log.debug("Ejecucion exitosa de ITestMercadoDineroService.testColocacionPrimariaRecompraBusinessRules()");
