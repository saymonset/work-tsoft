 ...
 */
package com.indeval.portaldali.middleware.services.exception.divisioninternacional.divisioninternacional;
...
public class ITestDivisionInternacionalService extends BaseITestService {
    ...
    public void testGetArqueoValoresLinea2() {
        ...
        log
                .debug("Saliendo de ITestDivisionInFternacionalService.testGetArqueoValoresLinea2()");
    }
    ...
    public void testGetArqueoValoresHistorico() {
        log
                .debug("Entrando a ITestDivisionInFternacionalService.testGetArqueoValoresHistorico()");
        assertNotNull(divisionInternacionalService);
        ...
        log
                .debug("Saliendo de ITestDivisionInFternacionalService.testGetArqueoValoresHistorico()");
    }
    ...
    public void testGetArqueoValoresHistotico2() {
        log
                .debug("Entrando a ITestDivisionInFternacionalService.testGetArqueoValoresHistotico2()");
        assertNotNull(divisionInternacionalService);
        ...
        log
                .debug("Saliendo de ITestDivisionInFternacionalService.testGetArqueoValoresHistotico2()");
    }
    ...
    public void testGetArqueoValoresExportacionLinea() {
        log
                .debug("Entrando a ITestDivisionInFternacionalService.testGetArqueoValoresExportacionLinea()");
        assertNotNull(divisionInternacionalService);
