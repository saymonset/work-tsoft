 ...
 *
 */
public class ITestGetListaEmisionesCapitales_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestGetListaEmisionesCapitales_1.class);
     ...
     */
    public void testGetListaEmisionesCapitales_1() throws BusinessException {
        
        log.info("Entrando a ITestGetListaEmisionesCapitales_1.testGetListaEmisionesCapitales_1()");
        
        assertNotNull(catalogoService);
        
        PaginaVO paginaVO = catalogoService.getListaEmisionesCapitales(new AgenteVO(), 
