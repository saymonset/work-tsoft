 ...
 */
public class ITestConsultaPosicionValores_e1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestConsultaPosicionValores_e1.class);
