 ...
 */
public class ITestEnvioOperacionesService_e1 extends BaseITestService {

    /** Objeto de loggeo para ITestEnvioOperacionesService */
    private static final Logger logger = LoggerFactory.getLogger(ITestEnvioOperacionesService_e1.class);
    ...
    public ITestEnvioOperacionesService_e1(String name) {
        super(name);
...
//        envioOperacionesService.reenviaOperacion(vo, folioControl, 1, false);
    ...
    public void testGetMensajeBitacoraMatch() throws Exception {
        ...
        params.setAgenteFirmado(new AgenteVO("02", "015"));

        // Calendar calendar = Calendar.getInstance();
        // calendar.set(2007, Calendar.OCTOBER, 19);

        // params.setFechaLiquidacion(calendar.getTime());
        params.setContraparte(new AgenteVO("02", "061"));

        EmisionVO emisionVO = new EmisionVO();
        emisionVO.setEmisora("ALSEA");
...
//        }
    ...
    public static Test suite() {
        ...
        suite.addTest(new ITestEnvioOperacionesService_e1("testactualizaEdoInsExpira"));
