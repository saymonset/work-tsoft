 ...
 */
public class ITestCapturaConcertacionPrestamos_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestCapturaConcertacionPrestamos_1.class);
