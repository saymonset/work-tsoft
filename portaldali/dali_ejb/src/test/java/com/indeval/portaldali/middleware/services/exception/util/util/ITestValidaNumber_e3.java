 ...
 * para el patron limite "tasa"
 * 
 * @author <a href="mailto:david.rengifo@itbrain.com.mx">David A. Rengifo R.</a>
 */
public class ITestValidaNumber_e3 extends BaseITestService {
    
    /** Patron para el limite del valor numerico */
    private static final String PATTER_LIMIT = "9999.999999";
     ...
     * @throws Exception
     */
    public void testValidaNumberTasaInteger() throws Exception {
     ...
     * @throws Exception
     */
    public void testValidaNumberTasaBigInteger() throws Exception {
     ...
     * @throws Exception
     */
    public void testValidaNumberTasaDouble() throws Exception {

        log.info("Entrando a ITestValidaNumber_1.testValidaNumber()");
        
        assertNotNull(utilService);
        
        Double numero = new Double("12345.6789012");
        try {
            utilService.validaNumber(numero, PATTER_LIMIT);
            log.debug("Verificar validacion");
            assertTrue(false);
     ...
     * @throws Exception
     */
    public void testValidaNumberTasaBigDecimal() throws Exception {

        log.info("Entrando a ITestValidaNumber_1.testValidaNumber()");
        
        assertNotNull(utilService);
        
        BigDecimal numero = new BigDecimal("12345.6789012");
        try {
            utilService.validaNumber(numero, PATTER_LIMIT);
            log.debug("Verificar validacion");
            assertTrue(false);
