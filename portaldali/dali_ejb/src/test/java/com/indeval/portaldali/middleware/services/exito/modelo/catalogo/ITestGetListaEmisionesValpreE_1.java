 ...
 *
 */
public class ITestGetListaEmisionesValpreE_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestGetListaEmisionesValpreE_1.class);
     ...
     */
    public void testGetListaEmisionesValpreE_1() throws BusinessException {
        
        log.info("Entrando a ITestGetListaEmisionesValpreE_1.testGetListaEmisionesValpreE_1()");
        
        assertNotNull(catalogoService);
        BigInteger idBoveda = new BigInteger("0");

        PaginaVO paginaVO = catalogoService.getListaEmisionesValpreE(new EmisionVO(), 
                new AgenteVO(), idBoveda, new PaginaVO());
