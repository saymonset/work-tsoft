 ...
 */
public class ITestColocacionPrimariaRecompra_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestColocacionPrimariaRecompra_1.class);
