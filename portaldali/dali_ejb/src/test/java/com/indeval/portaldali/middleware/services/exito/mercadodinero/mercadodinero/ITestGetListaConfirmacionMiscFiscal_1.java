 ...
 */
public class ITestGetListaConfirmacionMiscFiscal_1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final Logger logger = LoggerFactory.getLogger(ITestGetListaConfirmacionMiscFiscal_1.class);
