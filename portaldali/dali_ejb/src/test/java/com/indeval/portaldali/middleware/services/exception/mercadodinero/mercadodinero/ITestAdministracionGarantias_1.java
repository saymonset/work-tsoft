...
public class ITestAdministracionGarantias_1 extends BaseITestService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ITestAdministracionGarantias_1.class);
    ...
    public void testAdministracionGarantias() throws Exception {
        ...
        log.debug("Ejecución exitosa del testEJBAdministracionGarantias()");
