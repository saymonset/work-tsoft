 ...
 */
public class ITestRegistraOperacion_e1 extends BaseITestService {

    /** Objeto de loggeo de clase */
    private static final LLogger logger = LoggerFactory.getLogger(TestRegistraOperacion_e1.class);
    ...
    /**
     * TestCase para MercadoDineroDao.registraOperacion() Prueba para Recepcion
     * Traspasos de Fondos Service
     *
     * @throws BusinessException
     */
    public void testRegistraOperacion() throws BusinessException {
        
        log.info("Entrando a ITestRegistraOperacion_1.testRegistraOperacion()");
        ...
        String folio = mercadoDineroService.registraOperacion(params);
        long endTime = System.currentTimeMillis();
        double milisegundos = (endTime - startTime);
        log.debug("Milisegundos en responder el servicio RegistraOperacion():"
                + milisegundos);
        assertNotNull(folio);
        log.debug("Folio Operacion: [" + folio + "]");

        log.debug("Ejecucion exitosa del testEJBRegistraOperacion()");
