...
public interface LiquidacionDecretosService {
    ...
    /**
     * Obtiene los tipos de derecho (ejercicio) de la consulta correspondiente al params
     * porporcionados
     * @param params
    ...
    /**
     * Obtiene el detalle de cobros por decretos correspondiente a los parametros
     * proporcionados
     * @param paramsDetalle
     * @return LiquidacionDecretosDetalleVO Un objeto de la clase LiquidacionDecretosDetalleVO
     * @throws BusinessException
     */
    LiquidacionDecretosDetalleVO getLiquidacionDecretosDetalle(LiquidacionDecretosDetalleParams paramsDetalle) 
                throws BusinessException;
     ...
     * @return List Una lista de objetos LiquidacionDecretosDetalleAmortizacionesVO
     * @throws BusinessException
     */
    ...
    /**
     * Obtiene la lista de tipos de ejercicio del portal y de ejercicio de derechos
     * 
