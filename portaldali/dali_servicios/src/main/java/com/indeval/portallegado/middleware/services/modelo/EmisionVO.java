...
public class EmisionVO extends AbstractBaseDTO {
    ...
    public String toString() {
        StringBuffer sbEmisionVO = new StringBuffer(StringUtils.isNotBlank(this
                .toResumeString()) ? this.toResumeString() : "");
        if (StringUtils.isNotBlank(this.getMercado()))
            sbEmisionVO.append(" : " + this.getMercado().trim());
        if (StringUtils.isNotBlank(this.getAlta()))
            sbEmisionVO.append(" : " + this.getAlta().trim());
        if (StringUtils.isNotBlank(this.getCuponCortado()))
            sbEmisionVO.append(" : " + this.getCuponCortado().trim());
    ...
    public String toResumeString() {
        StringBuffer sbEmisionVO = new StringBuffer(StringUtils.isNotBlank(this
                .getIdTipoValor()) ? this.getIdTipoValor().trim() : "");
    ...
    public void tienePKValida() throws BusinessException {
        if (StringUtils.isBlank(this.idTipoValor)) {
            throw new BusinessException(
                    "Error: La emision tiene NULL o VACIO el atributo TV");
        }
        if (StringUtils.isBlank(this.emisora)) {
            throw new BusinessException(
                    "Error: La emision tiene NULL o VACIO el atributo EMISORA");
        }
        if (StringUtils.isBlank(this.serie)) {
            throw new BusinessException(
                    "Error: La emision tiene NULL o VACIO el atributo SERIE");
        }
        if (StringUtils.isBlank(this.cupon)) {
            throw new BusinessException(
                    "Error: La emision tiene NULL o VACIO el atributo CUPON");
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (valido) {
            ...
            if ((this.getIdTipoValor() == null && emision.getIdTipoValor() != null)
                    || (this.getEmisora() == null && emision.getEmisora() != null)
                    || (this.getSerie() == null && emision.getSerie() != null)
                    || (this.getCupon() == null && emision.getCupon() != null)) {
                valido = false;
            }
            if (valido) {
                if ((StringUtils.isNotBlank(this.idTipoValor) && !this.idTipoValor
                        .trim().equalsIgnoreCase(
                                emision.getIdTipoValor() == null ? null
                                        : emision.getIdTipoValor().trim()))
                        || (StringUtils.isNotBlank(this.emisora) && !this.emisora
                                .trim().equalsIgnoreCase(
                                        emision.getEmisora() == null ? null
                                                : emision.getEmisora().trim()))
                        || (StringUtils.isNotBlank(this.serie) && !this.serie
                                .trim().equalsIgnoreCase(
                                        emision.getSerie() == null ? null
                                                : emision.getSerie().trim()))
                        || (StringUtils.isNotBlank(this.cupon) && !this.cupon
                                .trim().equalsIgnoreCase(
                                        emision.getCupon() == null ? null
                                                : emision.getCupon().trim()))) {
                    valido = false;
                }
            }
        }
