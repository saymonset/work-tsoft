...
public class AgenteVO extends AbstractBaseDTO {
	...
	public boolean equals(Object obj) {
	    ...
	    if (this.equalsSinCuenta(obj)) {
	        AgenteVO agente = (AgenteVO) obj;

	        if (this.cuenta != null && agente.getCuenta() != null && this.cuenta.equals(agente.getCuenta().trim())){
	            valido = true;
	        }
	    } 
	    return valido;
	 ...
	 * 
	 */
	public boolean equalsSinCuenta(Object obj) {

	    boolean valido = false;
	    if (isAn(obj)) {
	        AgenteVO agente = (AgenteVO) obj;
	        
	        if(this.id != null && agente.getId() != null && this.id.equals(agente.getId().trim())){
	            valido = true;
	        }
	        
	        if(valido && (this.folio != null && agente.getFolio() != null && this.folio.equals(agente.getFolio().trim()))){
	            valido = true;
	        }
	        else {
	            valido = false;
	 ...
	 * @throws BusinessException
	 */
	public void tieneClaveValida(String tipoAgente) throws BusinessException {
		if (StringUtils.isBlank(this.getId())) {
			throw new BusinessException("Error: El agente " + tipoAgente + " tiene NULL o VACIO el atributo ID");
		}
		if (StringUtils.isBlank(this.getFolio())) {
			throw new BusinessException("Error: El agente " + tipoAgente + "tiene NULL o VACIO el atributo FOLIO");
		}
	}
	...
	/**
	 * Valida si la cuenta de este agente termina o comienza con el
	 * n&uacute;mero de cuenta propuesto en el parametro
	 * 
	 * @param esTerminacion
	 ...
	 * @return True si la cuenta termina o comienza con el n&uacute;mero
	 *         deseado. False lo contrario.
	 */
	...
	public String toString() {
		...
		StringBuffer sbAgenteVO = new StringBuffer(StringUtils.isNotBlank(this.toResumeString()) ? this.toResumeString() : "");
	...
	public String toResumeString() {
		StringBuffer sbAgenteVO = new StringBuffer(StringUtils.isNotBlank(this.getId()) ? this.getId().trim() : "");
