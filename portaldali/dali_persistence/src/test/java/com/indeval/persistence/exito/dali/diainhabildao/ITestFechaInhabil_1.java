 ...
 *
 */
public class ITestFechaInhabil_1 extends BaseDaoTestCase {
	
	/** Objeto de loggeo */
    private static final Logger logger = LoggerFactory.getLogger(ITestFechaInhabil_1.class);
	 ...
	 * @throws Exception
	 */
	public void testFechaInhabil_1() throws Exception {
		
		log.info("Entrando a ITestEsInhabil_1.testEsInhabil()");
		
		assertNotNull(diaInhabilDaliDao);
		
		Date fecha = DateUtil.getDate(2008, 03, 17, 0, 0);
