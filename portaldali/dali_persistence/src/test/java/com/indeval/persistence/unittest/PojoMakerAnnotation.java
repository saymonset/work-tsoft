...
public class PojoMakerAnnotation extends BaseDaoTestCase {
    ...
    private static final String TABLENAME = "T_OPERACION_NOMBRADA";
    ...
    private static final String ENTIDAD = "OperacionNombrada";
    ...
    public void testMakePojo() throws Exception {
        ...
        for(int i = 1; i <= rsmd.getColumnCount(); i++) {
            ...
            out.println("     @Column(name =\""+helper.getColumnName()+"\", unique = "+ !helper.isNullable() +", nullable = "+ helper.isNullable()+ ")");
