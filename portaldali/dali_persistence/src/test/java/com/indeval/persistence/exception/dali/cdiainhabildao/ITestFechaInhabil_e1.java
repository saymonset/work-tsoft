 ...
 *
 */
public class ITestFechaInhabil_e1 extends BaseDaoTestCase {
	
	/** Objeto de loggeo */
    private static final Logger logger = LoggerFactory.getLogger(ITestFechaInhabil_e1.class);
	 ...
	 * @throws Exception
	 */
	public void testFechaInhabil_e1() throws Exception {
		...
		try {
			diaInhabilDaliDao.fechaInhabil(null);
	 ...
	 * @throws Exception
	 */
	public void testFechaInhabil_e2() throws Exception {
		
		logger.info("Entrando a ITestEsInhabil_1.testEsInhabil()");
		
		assertNotNull(diaInhabilDaliDao);
		
		Date fecha = DateUtil.getDate(2008, 07, 17, 0, 0);
