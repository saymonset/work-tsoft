...
public class MovimientosEfectivoDAOV2Impl extends HibernateDaoSupport implements MovimientosEfectivoDAOV2 {
    ...
    private final Logger logger = LoggerFactory.getLogger(MovimientosEfectivoDAOV2Impl.class);

    private Long ID_CUENTA_DUMMY = 3909L;
    private boolean IS_DUMMY = true;
    ...
    public List<Long> buscarCuentasDeRegistrosContablesDeEfectivoControlada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarCuentasDeRegistrosContablesDeEfectivoControlada()");
        ...
        return (List<Long>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                List<BigInteger> ids = session.createQuery(query.toString()).setParameters(params.toArray(), tipos.toArray(new Type[]{})).list();
    ...
    public List<Long> buscarCuentasDeRegistrosContablesDeEfectivoControladaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarCuentasDeRegistrosContablesDeEfectivoControladaHistorico()");
    ...
    public List<Long> buscarCuentasDeRegistrosContablesDeEfectivoNombrada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarCuentasDeRegistrosContablesDeEfectivoNombrada()");
        ...
        return (List<Long>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                if (IS_DUMMY) {
                    resultados.add(ID_CUENTA_DUMMY);
                }
                return resultados;
            }
        });
    ...
    public List<Long> buscarCuentasDeRegistrosContablesDeEfectivoNombradaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarCuentasDeRegistrosContablesDeEfectivoNombradaHistorico()");
    ...
    public List<Long> buscarDivisasDeRegistrosContablesDeEfectivoControlada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarDivisasDeRegistrosContablesDeEfectivoControlada");
    ...
    public List<Long> buscarDivisasDeRegistrosContablesDeEfectivoControladaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarDivisasDeRegistrosContablesDeEfectivoControladaHistorico");
        ...
        return (List<Long>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                query.append(constuirCriteriosEfectivoControlada("reg", criterio, params, tipos, null, true));
                Query consulta = session.createQuery(query.toString()).setParameters(params.toArray(), tipos.toArray(new Type[]{}));
                List<BigInteger> ids = consulta.list();
                List<Long> resultados = DTOAssembler.transformarListaBigIntegerEnLong(ids);
    ...
    public List<Long> buscarDivisasDeRegistrosContablesDeEfectivoNombrada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarDivisasDeRegistrosContablesDeEfectivoNombrada");
    ...
    public List<Long> buscarDivisasDeRegistrosContablesDeEfectivoNombradaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarDivisasDeRegistrosContablesDeEfectivoNombradaHistorico");
    ...
    public List<RegistroContableSaldoControladaDTO> buscarRegistrosContablesDeEfectivoControlada(final CriterioConsultaMovimientosEfectivoDTO criterio, final List<Long> idsDivisas) {
        logger.debug("MovimientosEfectivoDAOV2Imp :: buscarRegistrosContablesDeEfectivoControlada");
        ...
        return (List<RegistroContableSaldoControladaDTO>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                query.append(" ORDER BY reg.saldo.cuentaControlada.institucion.tipoInstitucion.claveTipoInstitucion || " + "reg.saldo.cuentaControlada.institucion.folioInstitucion || " + "reg.saldo.cuentaControlada.cuenta, reg.saldo.divisa.idDivisa, reg.saldo.boveda.idBoveda,reg.fecha ");
...
//					resultado.add(DTOAssembler.crearRegistroContableSaldoControladaDTO(saldo));
    ...
    public List<RegistroContableSaldoControladaDTO> buscarRegistrosContablesDeEfectivoControladaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio, final List<Long> idsDivisas) {
        logger.debug("MovimientosEfectivoDAOV2Impl :: buscarRegistrosContablesDeEfectivoControladaHistorico");
        return (List<RegistroContableSaldoControladaDTO>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                StringBuffer query = new StringBuffer();
                ArrayList<Object> params = new ArrayList<Object>();
    ...
    public List<RegistroContableSaldoNombradaDTO> buscarRegistrosContablesDeEfectivoNombrada(final CriterioConsultaMovimientosEfectivoDTO criterio, final List<Long> idsDivisas) {
        logger.debug("buscarRegistrosContablesDeEfectivoNombrada");
        ...
        return (List<RegistroContableSaldoNombradaDTO>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                ArrayList<Object> params = new ArrayList<Object>();
                ArrayList<Object> tipos = new ArrayList<Object>();
                query.append("SELECT reg, (SELECT iopv.plazoReporto || ',' || iopv.tasaNegociada ");
                ...
                query.append("	, reg.operacion.instruccion.instruccionEfectivo.folioInstLiquidacion ");
                ...
                if (criterio.isOrdenarPorTipoDeInstruccion()) {
                    query.append(" ORDER BY reg.saldoNombrada.cuentaNombrada.institucion.tipoInstitucion.claveTipoInstitucion || " + "reg.saldoNombrada.cuentaNombrada.institucion.folioInstitucion || " + "reg.saldoNombrada.cuentaNombrada, reg.saldoNombrada.divisa.idDivisa, reg.saldoNombrada.boveda.idBoveda, reg.operacion.instruccion.tipoInstruccion.nombreCorto, reg.fecha ");
                } else {
                    query.append(" ORDER BY reg.saldoNombrada.cuentaNombrada.institucion.tipoInstitucion.claveTipoInstitucion || " + "reg.saldoNombrada.cuentaNombrada.institucion.folioInstitucion || " + "reg.saldoNombrada.cuentaNombrada, reg.saldoNombrada.divisa.idDivisa, reg.saldoNombrada.boveda.idBoveda, reg.fecha ");
                }
                Query hQuery = session.createQuery(query.toString()).setParameters(params.toArray(), tipos.toArray(new Type[]{}));
                QueryUtil.imprimir(query.toString(),params);
                ...
                for (Object[] elementos : registros) {
                    resultado.add(EnsambladorDTOConsultasEfectivo.
                            crearRegistroContableSaldoNombradaConDatosOperacionEInstruccion(
                                    (RegContEfecNombrada) elementos[0],
                                    (String) elementos[1],
                                    (TipoRetiro) elementos[2],
                                    (Integer) elementos[3],
                                    (BigInteger) elementos[4]));
                }
    ...
    public List<RegistroContableSaldoNombradaDTO> buscarRegistrosContablesDeEfectivoNombradaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio, final List<Long> idsDivisas) {
        logger.debug("buscarRegistrosContablesDeEfectivoNombradaHistorico");
        ...
        List<RegistroContableSaldoNombradaDTO> retorno = (List<RegistroContableSaldoNombradaDTO>) getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                ...
                query.append(" AND reg.fechaCreacion = reg.operacion.fechaCreacion  ");
                if (criterio.isOrdenarPorTipoDeInstruccion()) {
                    query.append(" ORDER BY reg.saldoNombradaHistorico.cuentaNombrada.institucion.tipoInstitucion.claveTipoInstitucion || " + "reg.saldoNombradaHistorico.cuentaNombrada.institucion.folioInstitucion || " + "reg.saldoNombradaHistorico.cuentaNombrada, reg.saldoNombradaHistorico.divisa.idDivisa, reg.saldoNombradaHistorico.boveda.idBoveda, reg.operacion.instruccion.tipoInstruccion.nombreCorto, reg.fecha ");
                } else {
                    query.append(" ORDER BY reg.saldoNombradaHistorico.cuentaNombrada.institucion.tipoInstitucion.claveTipoInstitucion || " + "reg.saldoNombradaHistorico.cuentaNombrada.institucion.folioInstitucion || " + "reg.saldoNombradaHistorico.cuentaNombrada, reg.saldoNombradaHistorico.divisa.idDivisa, reg.saldoNombradaHistorico.boveda.idBoveda, reg.fecha ");
                }
                Query hQuery = session.createQuery(query.toString()).setParameters(params.toArray(), tipos.toArray(new Type[]{}));
                ...
                List<RegistroContableSaldoNombradaDTO> resultado = new ArrayList<RegistroContableSaldoNombradaDTO>();
                for (Object[] elementos : registros) {
                    resultado.add(EnsambladorDTOConsultasEfectivo.crearRegistroContableSaldoNombradaConDatosOperacionEInstruccionHistorico((RegContEfecNombradaHistorico) elementos[0], (String) elementos[1], (TipoRetiro) elementos[2], (Integer) elementos[3], dateUtilsDao.getDateFechaDB()));
                }
    ...
    public long obtenerProyeccionDeRegistrosContablesDeSaldosControlada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("obtenerProyeccionDeRegistrosContablesDeSaldosControlada");
    ...
    public long obtenerProyeccionDeRegistrosContablesDeSaldosControladaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("obtenerProyeccionDeRegistrosContablesDeSaldosControladaHistorico");
    ...
    public long obtenerProyeccionDeRegistrosContablesDeSaldosNombrada(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("obtenerProyeccionDeRegistrosContablesDeSaldosNombrada");
    ...
    public long obtenerProyeccionDeRegistrosContablesDeSaldosNombradaHistorico(final CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("obtenerProyeccionDeRegistrosContablesDeSaldosNombradaHistorico");
     ...
     */
    private String constuirCriteriosEfectivoControlada(String alias, CriterioConsultaMovimientosEfectivoDTO criterio, ArrayList<Object> params, ArrayList<Object> tipos, List<Long> idsDivisas, Boolean isHistorico) {
        ...
        if (criterio.getCuenta() != null && !"-1".equals(criterio.getCuenta().getNumeroCuenta())) {
            query.append("AND (" + alias + ".saldo.cuentaControlada.institucion.tipoInstitucion.claveTipoInstitucion " + "|| " + alias + ".saldo.cuentaControlada.institucion.folioInstitucion || " + "" + alias + ".saldo.cuentaControlada.cuenta)" + " = ? ");
     ...
     */
    private String constuirCriteriosEfectivoNombrada(String alias, CriterioConsultaMovimientosEfectivoDTO criterio, ArrayList<Object> params, ArrayList<Object> tipos, List<Long> idsDivisas, Boolean isHistorico) {
        StringBuffer query = new StringBuffer();
        ...
        if (criterio.getCuenta() != null && !"-1".equals(criterio.getCuenta().getNumeroCuenta())) {
            ...
            if (StringUtils.isNotBlank(numeroCuenta) && numeroCuenta.length() == 9) {
...
//			tipos.add(new StringType());
        ...
        if (criterio.getEmision() != null && criterio.getEmision().getSerie() != null && StringUtils.isNotBlank(criterio.getEmision().getSerie().getSerie()) && !criterio.getEmision().getSerie().getSerie().equals("-1")) {
        ...
        if (criterio.getEmision() != null && criterio.getEmision().getEmisora() != null && criterio.getEmision().getEmisora().getId() > 0) {
            ...
            if (criterio.getEmision() != null && criterio.getEmision().getEmisora() != null && StringUtils.isNotBlank(criterio.getEmision().getEmisora().getDescripcion()) && !"TODOS".equalsIgnoreCase(criterio.getEmision().getEmisora().getDescripcion())) {
        ...
        if (criterio.getEmision() != null && criterio.getEmision().getTipoValor() != null && criterio.getEmision().getTipoValor().getId() > 0) {
            ...
            if (criterio.getEmision() != null && criterio.getEmision().getTipoValor() != null && StringUtils.isNotBlank(criterio.getEmision().getTipoValor().getClaveTipoValor())) {
        ...
        if (criterio.getEmision() != null && criterio.getEmision().getTipoValor() != null && criterio.getEmision().getTipoValor().getMercado() != null && criterio.getEmision().getTipoValor().getMercado().getId() > 0) {
         ...
         */
        if (StringUtils.isNotBlank(criterio.getTipoRetiro()) && !"-1".equals(criterio.getTipoRetiro()) && (TipoRetiroConstants.NOMBRE_CORTO_RETIRO_SPEI.equalsIgnoreCase(criterio.getTipoRetiro().trim()) || TipoRetiroConstants.NOMBRE_CORTO_RETIRO_SIAC.equalsIgnoreCase(criterio.getTipoRetiro().trim()))) {
            String tipoDeposito = "";
        ...
        if (criterio.getRolContraparte() == RolCuentaConstants.AMBOS) {
            ...
            query.append(" AND (   (" + construirCriteriosCuentaContraparte("reg", "Receptor", criterio, params, tipos) + " AND (" + " reg.operacion.idCuentaEfectivoTraspasante is null OR " + " reg.operacion.idCuentaEfectivoTraspasante = reg.saldoNombrada.cuentaNombrada.idCuentaNombrada ) " + ")  " + "OR  (" + construirCriteriosCuentaContraparte("reg", "Traspasante", criterio, params, tipos) + " AND (" + " reg.operacion.idCuentaEfectivoReceptor is null OR " + " reg.operacion.idCuentaEfectivoReceptor = reg.saldoNombrada.cuentaNombrada.idCuentaNombrada ) " + ") ) ");
        ...
        if (criterio.getRolContraparte() == RolCuentaConstants.RECEPTOR) {
            ...
            query.append(" AND ( reg.saldoNombrada.cuentaNombrada.idCuentaNombrada =  reg.operacion.idCuentaNombradaTraspasante " + "OR " + " reg.operacion.idCuentaNombradaTraspasante is null" + ")");
        ...
        if (criterio.getRolContraparte() == RolCuentaConstants.TRASPASANTE) {
            ...
            query.append(" AND ( reg.saldoNombrada.cuentaNombrada.idCuentaNombrada =  reg.operacion.idCuentaNombradaReceptor" + " OR " + " reg.operacion.idCuentaNombradaReceptor is null" + ")");
        ...
        if (criterio.getRolParticipante() != RolCuentaConstants.AMBOS) {
            ...
            if (criterio.getRolParticipante() == RolCuentaConstants.TRASPASANTE) {
                query.append(" AND (  " + " ( reg.operacion.idCuentaEfectivoTraspasante = reg.saldoNombrada.cuentaNombrada.idCuentaNombrada OR " + " reg.operacion.idCuentaEfectivoTraspasante is null ) " + "  ) ");
            } else {
                query.append(" AND (  " + "  ( reg.operacion.idCuentaEfectivoReceptor = reg.saldoNombrada.cuentaNombrada.idCuentaNombrada OR " + " reg.operacion.idCuentaEfectivoReceptor is null ) " + "  ) ");
            }
        ...
        query.append(" AND reg.operacion.tipoOperacion.claveTipoOperacion NOT IN ('").append(Constantes.BLOQUEO_EFECTIVO).append("','").append(Constantes.DESBLOQUEO_EFECTIVO).append("') ");
     ...
     * de la contraparte.
     *
     * @param alias                  Alias de la tabla de registro contable a utilizar.
     * @param aliasCuentaContraparte Alias o nombre de la propiedad de cuenta a utilizar. Los
     *                               valores válidos son Traspasante y Receptor
     * @param criterio               Criterio para construir los parámetros.
     * @param params                 Lista de parámetros nuevos que los criterios agregan.
     * @param tipos                  Lista de tipos nuevos que los criterios agregan.
     * @return Cadena con la parte de la consulta que involucra los criterios.
     */
    private String construirCriteriosCuentaContraparte(String alias, String aliasCuentaContraparte, CriterioConsultaMovimientosEfectivoDTO criterio, ArrayList<Object> params, ArrayList<Object> tipos) {
        StringBuffer query = new StringBuffer();
