...
/**
 * Tabla que contiene los registros contables historicos correspondientes a los movimientos
 * o acciones que se realizaron sobre las cuentas controladas de efectivo.
 * 
 * T_REG_CONTABLE_EFE_CONTROL_H
 * 
 * @author rchavez
 * @version 1.0
 */
@Entity
@Table(name = "T_REG_CONTABLE_EFE_CONTROL_H")
public class RegContEfecControladaHistorico implements Serializable {
    /**
     * serialVersionUID.
     */
     ...
     */
    public RegContEfecControladaHistorico() {
    }
     ...
     */
    public RegContEfecControladaHistorico(BigInteger idSaldo, TipoAccion tipoAccion, BigDecimal importe,
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof RegContEfecControladaHistorico)) {
            return false;
        }
        if (this == obj) {
            return true;
        }
        RegContEfecControladaHistorico rhs = (RegContEfecControladaHistorico) obj;
