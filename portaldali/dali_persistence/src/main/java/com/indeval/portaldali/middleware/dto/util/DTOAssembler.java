...
//		reteVO.setPago203(paago203);
	 ...
	 * 
	 * @param tipoCuenta
	 *            Tipo de cuenta origen para crear el tipo de naturaleza
	 * @return DTO creado a partir del parámetro de entrada
	 */
	 ...
	 * 
	 * @param divisa
	 *            Objeto de hibernate con los valores a setear
	 ...
	 * 
	 * @param posicion
	 *            Objeto de hibernate fuete para construir el DTO
	 ...
	 * 
	 * @param mercado
	 *            Objeto de hibernate que sirve de base para crear el DTO de
	 *            salida
	 ...
	 * {@link EstadoCuentaEfectivoPorRegistroContableDTO} a partir de un objeto
...
//		* Concepto en la instruccion de efectivo
	 ...
	 * 
	 * @param bo
	 *            Objeto con los datos fuente
	 * @param mensajeBean
	 * @param participante
	 *            Datos de la institución participante para tomar decisiones al
	 *            momento de crear el DTO
	 * @param incluirParcialidades
	 *            Indica si debe crear un objeto por cada parcialidad asociada
	 *            con el registro.
	 * @param idEstadoInstruccion
	 *            el identificador el estado de la instrucción solicitada. Si el
 ...
 */
	 ...
	 * 
	 * @param listaBigInt
	 *            una lista con elementos BigInteger
	 ...
	 * 
	 * @param posicionHistorica
	 *            el BO del cual se toman los datos.
	 ...
	 * 
	 * @param el CuentaRetiroInternacional del cual se toman los datos.
	 * @return el DTO creado.
	 */	
	public static CuentaRetiroInternacionalDTO crearCuentaRetiroInternacionalDTO(CuentaRetiroInternacional cuenta){
	 ...
	 */	
	public static CuentaRetiroInternacional crearCuentaRetiroInternacional(CuentaRetiroInternacionalDTO cuentaDTO){
	 ...
	 * 
	 * @param el CuentaRetiro del cual se toman los datos.
	 * @return el model creado.
	 */	
	 ...
	 * 
	 * @param el BitacoraEstadosCuentaRetiro del cual se toman los datos.
	 * @return el model creado.
	 */	
	public static BitacoraEdosCuentaRetiroDTO crearBitacoraEdosCuentaRetiroDTO(BitacoraEstadosCuentaRetiro bec){
	 ...
	 * 
	 * @param el CuentaRetiroNacional del cual se toman los datos.
	 * @return el model creado.
	 */	
	public static CuentaRetiroNacional crearCuentaRetiroNacional(CuentaRetiroEfectivoDTO cuentaDTO){
	 ...
	 * @return el model creado.
	 */	
	public static CuentaRetiroInternacional crearCuentaRetiroInternacional(CuentaRetiroEfectivoDTO cuentaDTO){
		CuentaRetiroInternacional cuenta = null; 
	 ...
	 * 
	 * @param el ParametrosDali del cual se toman los datos.
	 * @return el model creado.
	 */	
	 ...
	 * 
	 * @param el RetiroEfectivoDTO del cual se toman los datos.
	 * @return el model creado.
	 */	
	 ...
	 * 
	 * @param el RetiroEfectivo del cual se toman los datos.
	 * @return el model creado.
	 */	
	 ...
	 * 
	 * @param el RetiroEfectivoInternacional del cual se toman los datos.
	 * @return el model creado.
	 */	
	public static RetiroEfectivoInternacionalDTO crearRetiroEfectivoInternacionalDTO(RetiroEfectivoInternacional retiro){
