...
import com.indeval.dali.pages.mercado.dinero.TraspasosAdministrativosPage;
...
public class TraspasosAdministrativosTest extends BaseCapturaOperacionesTest{
	...
	private String[][] dpTraspasoAdministrativo() throws IOException {
		return getDataPool("com/indeval/tests/mercado/dinero/dpTraspasoAdministrativo.csv");        
	}
