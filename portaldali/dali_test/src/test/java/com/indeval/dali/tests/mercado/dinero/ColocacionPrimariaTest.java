...
import com.indeval.dali.pages.mercado.dinero.ColocacionPrimariaPage;
import com.indeval.dali.tests.BaseCapturaOperacionesTest;

public class ColocacionPrimariaTest extends BaseCapturaOperacionesTest{
	
	
	@Page
	private ColocacionPrimariaPage page;
	
	
	

	
	@Test(dataProvider = "dpColocacionPrimaria",groups={"funcionales"})
	public void testFuncional(final String idFolioTraspasante,final String tipoCuentaTraspasante,final String idFolioReceptor,final String tipoCuentaReceptor,final String cantidadOperada,final String precioTitulo,final String comprador,final String tipoOperacion,final String plazoLiquidacion,final String mensajeEsperado) throws Exception{
		...
		goTo(ColocacionPrimariaPage.class);
	...
	@DataProvider(name = "dpColocacionPrimaria")
	private String[][] getdpColocacionPrimaria() throws IOException {
		return getDataPool("com/indeval/tests/mercado/dinero/dpColocacionPrimaria.csv");        
	}
