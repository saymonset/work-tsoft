...
public class ConsultaMovimientosEfectivoV2ServiceImpl implements ConsultaMovimientosEfectivoService {
    private final static Logger logger = LoggerFactory.getLogger(ConsultaMovimientosEfectivoV2ServiceImpl.class);
    ...
    public List<Long> buscarCuentasDeRegistrosContablesDeEfectivo(CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarCuentasDeRegistrosContablesDeEfectivo()");
    ...
    public List<Long> buscarDivisasDeRegistrosContablesDeEfectivo(CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("buscarDivisasDeRegistrosContablesDeEfectivo()");
    ...
    public long obtenerProyeccionDeRegistrosContablesDeMovimientosDeEfectivo(CriterioConsultaMovimientosEfectivoDTO criterio) {
        logger.debug("obtenerProyeccionDeRegistrosContablesDeMovimientosDeEfectivo()");
        long resultado = 0;
        if (DateUtils.isSameDay(criterio.getFechaFinal(), new Date())) {
            if (TipoCuentaConstants.TIPO_CONTROLADA.equals(criterio.getCuenta().getTipoCuenta().getId())) {
    ...
    public List<EstadoCuentaEfectivoPorDivisaDTO> consultarMovimientosDeEfectivo(CriterioConsultaMovimientosEfectivoDTO criterio, List<Long> idsDivisas, Boolean debeDejarLog) {
        logger.debug("consultarMovimientosDeEfectivo()");
        logger.debug("ConsultaMovimientosEfectivoV2ServiceImpl :: consultarMovimientosDeEfectivo");
        logger.debug("Criterio :: Tipo de cuenta :: " + criterio.getCuenta().getTipoCuenta().getId());
     ...
     *
     * @param criterio   Criterio para ejecutar la consulta de registro contables.
     * @param idsDivisas Conjunto de divisas para las que se realizar la consulta.
     * @return Lista de registros contables de movimientos de efectivo
     * organizados por divisa y bóveda.
     */
    private List<EstadoCuentaEfectivoPorDivisaDTO> consultarMovimientosDeEfectivoDeCuentasContrloladas(
            CriterioConsultaMovimientosEfectivoDTO criterio, List<Long> idsDivisas) {
        logger.debug("consultarMovimientosDeEfectivoDeCuentasContrloladas()");
        logger.debug("ConsultaMovimientosEfectivoV2ServiceImpl :: consultarMovimientosDeEfectivoDeCuentasContrloladas");
     ...
     * organizados por divisa y bóveda.
     */
    private List<EstadoCuentaEfectivoPorDivisaDTO> consultarMovimientosDeEfectivoDeCuentasNombradas(
            CriterioConsultaMovimientosEfectivoDTO criterio, List<Long> idsDivisas) {
        logger.debug("consultarMovimientosDeEfectivoDeCuentasNombradas()");
        logger.debug("ConsultaMovimientosEfectivoV2ServiceImpl :: consultarMovimientosDeEfectivoDeCuentasNombradas");
        List<EstadoCuentaEfectivoPorDivisaDTO> detalleEstadoCuenta = new ArrayList<EstadoCuentaEfectivoPorDivisaDTO>();
        if (idsDivisas != null && idsDivisas.size() > 0) {
     ...
     *      java.util.List)
     */
    public List<RegistroContableSaldoControladaDTO> consultarMovimientosDeEfectivoControladasSinAgrupar(
            CriterioConsultaMovimientosEfectivoDTO criterio, List<Long> idsDivisas) {
        logger.debug("consultarMovimientosDeEfectivoControladasSinAgrupar()");
     ...
     *      java.util.List)
     */
    public List<RegistroContableSaldoNombradaDTO> consultarMovimientosDeEfectivoNombradasSinAgrupar(
            CriterioConsultaMovimientosEfectivoDTO criterio, List<Long> idsDivisas) {
        logger.debug("consultarMovimientosDeEfectivoNombradasSinAgrupar()");
     ...
     *
     * @param movimientosEfectivoDAO el valor de movimientosEfectivoDAO a asignar
     */
