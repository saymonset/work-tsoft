...
public class ConsultaDetalleMovimientoEfectivoServiceImpl implements ConsultaDetalleMovimientoEfectivoService {
    ...
    /* (non-Javadoc)
     * @see com.indeval.estadocuenta.core.application.services.ConsultaDetalleMovimientoEfectivoService#consultarDetalleMovimientoEfectivo(long, boolean, long)
     */
    public DetalleMovimientoEfectivoDTO consultarDetalleMovimientoEfectivo(
            long idRegistroContable, boolean isHistorico, long idFolioInstLiquidacion) {
        //DTO con el detalle del movimiento
        DetalleMovimientoEfectivoDTO detalleMovimientoEfectivoDTO =
                detalleMovimientoEfectivoDAO.consultarDetalleMovimientoEfectivo(idRegistroContable, isHistorico, idFolioInstLiquidacion);
