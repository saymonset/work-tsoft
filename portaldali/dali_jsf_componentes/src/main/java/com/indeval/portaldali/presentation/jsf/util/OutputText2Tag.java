...
public class OutputText2Tag extends HtmlOutputTextTagBase {

    private final String COMPONENT_TYPE = "indeval.outputText2";
    private final String RENDER_TYPE = "indeval.outputText2";
