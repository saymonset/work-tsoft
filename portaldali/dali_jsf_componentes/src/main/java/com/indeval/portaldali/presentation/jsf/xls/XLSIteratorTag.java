...
public class XLSIteratorTag extends UIComponentTagBase {

    private Logger logger = LoggerFactory.getLogger(XLSIteratorTag.class);
    private String var;
    ...
    protected void setProperties(UIComponent component) {
        ...
        XLSIteratorComponent itComponent = (XLSIteratorComponent)component; 
