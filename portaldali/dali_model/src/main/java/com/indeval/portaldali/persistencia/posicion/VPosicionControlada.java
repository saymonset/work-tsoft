 ...
 */
@Entity
@Table(name="V_POSICION_CONTROLADA")
public class VPosicionControlada extends Posicion implements Serializable {

	/** Id para la serializacion */
	private static final long serialVersionUID = -7132239396996350017L;
	 ...
	 */
	@Formula("POSICION * VALOR_NOMINAL")
