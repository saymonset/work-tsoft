...
0,		// Padding
'[/dali/images/fondo_menu_main.gif]',	// Background ('color','transparent','[image_source]')
...
4,		// Padding
'[/dali/images/fondo_menu_main.gif]',	// Background ('color','transparent','[image_source]')
'[/dali/images/fondo_menu_main.gif]',	// OVER Background
'#ffffff',	// Color
'#ffffff',	// OVER Color
...
'[/dali/images/004.gif]',	// SubMenuImageSource ('[image_source]')
'[/dali/images/004.gif]',	// OverSubMenuImageSource
5,			// SubMenuImageWidth
9,			// SubMenuImageHeight
'8',			// SubMenuImageVAlign ('pixels from item top','middle')
'solid',		// VISITED BorderStyle
'#ffffff',		// VISITED BorderColor
'[/dali/images/fondo_menu_main.gif]',		// VISITED Background
'#ffffff',		// VISITED Color
'none',			// VISITED TextDecoration
'[/dali/images/004.gif]',	// VISITED SubMenuImageSource
'solid',		// CURRENT BorderStyle
'#ffffff',		// CURRENT BorderColor
'[/dali/images/fondo_menu_main.gif]',		// CURRENT Background
'#ffffff',		// CURRENT Color
'none',			// CURRENT TextDecoration
'[/dali/images/004.gif]',	// CURRENT SubMenuImageSource
