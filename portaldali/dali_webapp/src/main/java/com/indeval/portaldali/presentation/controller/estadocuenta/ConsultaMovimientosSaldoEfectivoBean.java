...
public class ConsultaMovimientosSaldoEfectivoBean extends BackingBeanBase {
    ...
    public void cambioSelectPapelMercado(ActionEvent e) {
        logger.debug("cambioSelectPapelMercado");
    ...
    public void cambioSelectTipoValor(ActionEvent e) {
        logger.debug("cambioSelectTipoValor");
...
//		}
    ...
    public String getDescripcionTipoValor() {
        logger.debug("getDescripcionTipoValor");
     ...
     *
     * @param emisoraSeleccionada el emisoraSeleccionada a establecer
     */
     ...
     * proporcionado.
     *
     * @param value el prefijo a consultar en la BD.
    ...
    public List<EmisoraDTO> buscarEmisorasPorPrefijo(Object value) {
        logger.debug("buscarEmisorasPorPrefijos");
     ...
     *
     * @param papelMercado el valor del atributo papelMercado a establecer
     */
     ...
     *
     * @param cuentaValoresContraparte el valor del atributo cuentaValoresContraparte a establecer
     */
    ...
    private void inicializarCriterios() {
        logger.debug("inicializarCriterios");
    ...
    public void buscarMovimientos() {
        logger.debug("Buscar Movimientos");
        boolean fechaInicioValida = validarFechaObligatoria(consultaMovimientos.getCriterioFechaInicial(), false, CamposPantallaConstantes.campoFechaInicial);
        boolean fechaFinValida = validarFechaObligatoria(consultaMovimientos.getCriterioFechaFinal(), false, CamposPantallaConstantes.campoFechaFinal);
        logger.debug("------------------------------------------ FECHA VALIDAS ------------------------------------------");
        logger.debug("Fecha Inicial: " + fechaInicioValida);
        logger.debug("               " + consultaMovimientos.getCriterioFechaInicial());
        logger.debug("               " + CamposPantallaConstantes.campoFechaInicial);
        logger.debug("Fecha Final " + fechaFinValida);
        logger.debug("            " + consultaMovimientos.getCriterioFechaFinal());
        logger.debug("            " + CamposPantallaConstantes.campoFechaFinal);

        boolean fechasValidas = fechaInicioValida && fechaFinValida;

        logger.debug("fechas validas :: " + fechasValidas);
        if (fechasValidas) {
            consultaMovimientos.setDivisaSeleccionada(null);
            consultaMovimientos.setBovedaSeleccionada(null);
            consultaMovimientos.setCuentaSeleccionada(null);
    ...
    public List<Integer> getListaPaginasResultado() {
        logger.debug("getListaPaginasResultado");
    ...
    private void obtenerTotaleRegistros(List<RegistroContableSaldoNombradaDTO> resultados) {
        logger.debug("obtenerTotaleRegistros");
    ...
    private void asignarPantallaDetalle(List<EstadoCuentaEfectivoPorDivisaDTO> listaEmisiones) {
        logger.debug("asignarPantallaDetalle");
     ...
     *
     * @param consultaMovimientos el valor de consultaMovimientos a asignar
     */
     ...
     *
     * @param cuentaContraparteSeleccionada el valor de cuentaContraparteSeleccionada a asignar
     */
     ...
     *
     * @param value el prefijo a consultar.
     ...
     *
     * @param institucionContraparteSeleccionada el valor de institucionContraparteSeleccionada a asignar
     */
        ...
        if ("movimientosEfectivoExcel".equals(reporte) || "movimientosEfectivoTexto".equals(reporte)) {
            if (TipoCuentaConstants.TIPO_CONTROLADA.equals(consultaMovimientos.getCuentaSeleccionada().getTipoCuenta().getId())) {
                ...
                if (resultadosControladasReporteXls != null) {
                    logger.debug("resultadosControladasReporteXls : " + resultadosControladasReporteXls.size());
                }
            } else {
                resultadosNombradasReporteXls = consultaMovimientos.getResultadosNombradasSinAgrupar();
                if (resultadosNombradasReporteXls != null) {
                    logger.debug("resultadosNombradasReporteXls : " + resultadosNombradasReporteXls.size());
                }
            }
            if (resultadosNombradasReporteXls != null) {
            ...
            if (resultados != null) {
                if (resultados != null) {
                    logger.debug("resultados Movimientos saldo efectivo : " + resultados.size());
                }
                int numeroRegistrosEncontrados = 0;
                for (EstadoCuentaEfectivoPorDivisaDTO porDivisa : resultados) {
                    for (DetalleEstadoCuentaSaldoPorBovedaDTO porBoveda : porDivisa.getRegistrosContablesPorBoveda()) {
     ...
     *
     * @param restaurarPaginacionResultados el valor del atributo restaurarPaginacionResultados a
     *                                      establecer.
     */
     ...
     *
     * @param consultaCatalogos el valor del atributo consultaCatalogos a establecer.
     */
     ...
     *
     * @param totalResultados el valor del atributo totalResultados a establecer.
     */
     ...
     *
     * @param totalAbono el valor del atributo totalAbono a establecer.
     */
     ...
     *
     * @param totalCargo el valor del atributo totalCargo a establecer.
     */
     ...
     *
     * @param resultadosControladasReporteXls el valor del atributo resultadosControladasReporteXls a
     *                                        establecer.
     */
     ...
     *
     * @param resultadosNombradasReporteXls el valor del atributo resultadosNombradasReporteXls a
     *                                      establecer.
     */
     ...
     *
     * @param institucionConsultada el valor del atributo institucionConsultada a establecer.
     */
     ...
     *
     * @param tipoInstruccionDaliDAO el valor del atributo tipoInstruccionDaliDAO a establecer
     */
