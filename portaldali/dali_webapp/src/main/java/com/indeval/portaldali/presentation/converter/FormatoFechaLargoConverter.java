 ...
 * @version 1.0
 */
public class FormatoFechaLargoConverter implements Converter {
	
	private static SimpleDateFormat sdf = new SimpleDateFormat(DaliConstants.FORMATO_FECHA_LARGO);
	/*
	 * (non-Javadoc)
