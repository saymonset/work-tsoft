 ...
 * @version 1.0
 */
public class FormatoMonedaConverter implements Converter {
	DecimalFormat df = new DecimalFormat(DaliConstants.FORMATO_MONEDA);
	/* (non-Javadoc)
	...
	public String getAsString(FacesContext ctx, UIComponent ui, Object objeto)
			throws ConverterException {
		String res = null;
		if(objeto!=null && StringUtils.isNotBlank(objeto.toString())){
