 ...
 * Este converter toma en cuenta el campo numeroCuenta del DTO
 * @author Emigdio Hernández
 * @version 1.0
 */
public class CuentaDTONumeroCuentaConverter implements Converter {
	...
	public String getAsString(FacesContext context, UIComponent component, Object value)
		...
		String resultado = "";
		if(value != null) {
			resultado = ((CuentaDTO)value).getNumeroCuenta();
		}
		return resultado;
	}
