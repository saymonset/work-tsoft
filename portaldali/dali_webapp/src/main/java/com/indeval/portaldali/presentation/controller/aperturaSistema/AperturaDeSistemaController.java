 ...
 */
package com.indeval.portaldali.presentation.controller.aperturaSistema;
...
public class AperturaDeSistemaController extends CapturaOperacionesController {
	...
	/** Indica el tipo de mercado para la apertura de sistema */
	...
	/** Trasa de log */
	private final Logger log = LoggerFactory.getLogger(AperturaDeSistemaController.class);
	...
	private void registrarOperacion() {
		...
		if(mercado.equals(TraspasoMercadoDineroParams.MERCADO_DINERO)){
			// SE TRATA DE MERCADO DE DINERO
			params.setMercadoDinero(true);			
		}else{
			// SE TRATA DE MERCADO DE CAPITALES
