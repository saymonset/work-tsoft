        ...
        <div className="flex">
            <div className="relative z-0 w-40 mr-28">
                <input
                    ...
                    onChange={(e) => {
                        setFechaProcesoRV(e);
                        onCurrentDateChange(e.target.value);
                    }}
                />
                <label
            ...
            <div className="ml-24 relative z-0 w-40">
                <select defaultValue="default"
                    ...
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
                            ...
                            focus:outline-none
                            focus:ring-0 peer"
                    value={selectedVectorRV}
                    onChange={(e) => {
                        setSelectVector(e);
                        onProcessSelectionChange(e.target.value !== "default");
                    }}
                >
                    <option value="...">...</option>
                    <option value="DEFINITIVO">DEFINITIVO</option>
                </select>
                <label htmlFor="s_vector"
            ...
            <div className="flex-1 mr-6 text-right text-cyan-700 font-bold">
                <button
                    className="bg-cyan-700 hover:bg-green-700
                                    text-white py-1 rounded-md px-3 mx-1" onClick={handleErase}>
                    <span>Limpiar</span>
                </button>
            </div>
        </div>
