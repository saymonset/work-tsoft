...
public class W8IMY2015Util {
	...
	static {
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4a", "1");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4b", "2");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4c", "9");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4d", "3");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4e", "4");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4f", "5");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4g", "6");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4h", "7");
		W8IMY2015Util.w8ImyParteI4Campos.put("partIcmp4i", "8");
		
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4a", "topmostSubform[0].Page1[0].Line4[0].c1_001[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4b", "topmostSubform[0].Page1[0].Line4[0].c1_002[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4c", "topmostSubform[0].Page1[0].Line4[0].c1_003[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4d", "topmostSubform[0].Page1[0].Line4[0].c1_004[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4e", "topmostSubform[0].Page1[0].Line4[0].c1_005[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4f", "topmostSubform[0].Page1[0].Line4[0].c1_006[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4g", "topmostSubform[0].Page1[0].Line4[0].c1_007[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4h", "topmostSubform[0].Page1[0].Line4[0].c1_008[0]");
		W8IMY2015Util.w8ImyParteI4Valores.put("partIcmp4i", "topmostSubform[0].Page1[0].Line4[0].c1_009[0]");
		
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5b", "2"); // 11
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5c", "3"); // 12
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5d", "4"); // 13
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5f", "6"); // 15
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5i", "9"); // 18
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5l", "8"); // 21
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5m", "12"); // 22
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5n", "12"); // 23
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5o", "13"); //24
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5p", "14"); //25
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5q", "15"); //26
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5r", "16"); //27
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5u", "16"); // 30
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5v", "18"); // 31
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5w", "19"); //32
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5x", "19"); //33
		W8IMY2015Util.w8ImyParteI5Campos.put("partIcmp5y", "19"); //34

		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5b", "topmostSubform[0].Page1[0].c1_011[0]"); // 11
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5c", "topmostSubform[0].Page1[0].c1_012[0]"); // 12
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5d", "topmostSubform[0].Page1[0].c1_013[0]"); // 13
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5f", "topmostSubform[0].Page1[0].c1_015[0]"); // 15
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5i", "topmostSubform[0].Page1[0].c1_018[0]"); // 18
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5l", "topmostSubform[0].Page1[0].c1_021[0]"); // 21
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5m", "topmostSubform[0].Page1[0].c1_022[0]"); // 22
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5n", "topmostSubform[0].Page1[0].c1_023[0]"); // 23
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5o", "topmostSubform[0].Page1[0].c1_024[0]"); //24
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5p", "topmostSubform[0].Page1[0].c1_025[0]"); //25
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5q", "topmostSubform[0].Page1[0].c1_026[0]"); //26
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5r", "topmostSubform[0].Page1[0].c1_027[0]"); //27
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5u", "topmostSubform[0].Page1[0].c1_030[0]"); // 30
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5v", "topmostSubform[0].Page1[0].c1_031[0]"); // 31
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5w", "topmostSubform[0].Page1[0].c1_032[0]"); //32
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5x", "topmostSubform[0].Page1[0].c1_033[0]"); //33
		W8IMY2015Util.w8ImyParteI5Valores.put("partIcmp5y", "topmostSubform[0].Page1[0].c1_034[0]"); //34
	}
	 ...
	 */
	public static void checarApendicesCampo4(FormaW8IMY2015 w8imy) {
		...
		w8imy.setPartVIII(w8imy.isPartIcmp4g() || w8imy.isPartIcmp4h() || w8imy.isPartIcmp4i() ? true : false);
	}
	 ...
	 * @param w8imy Forma W8IMY sobre la cual se prenden o apagan los booleanos.
	 */
	public static void checarApendicesCampo5(FormaW8IMY2015 w8imy) {
	 ...
	 * @return Apendice
	 */
	public static String obtenerApendiceCampo4(FormaW8IMY2015 w8imy) {
	 ...
	 * @return Apendice
	 */
	public static String obtenerApendiceCampo5(FormaW8IMY2015 w8imy) {
	 ...
	 */
	public static void deshabilitarDomicilioCorreo(boolean deshabilitaDomicilioCorreo, FormaW8IMY2015 w8imy) {
	...
	/**
	 * Verifica las partes del formato para colocar a null o false los campos de las
	 * partes no seleccionadas.
	 * @param w8imy Forma sobre la cual se realiza la verificación.
	 */
	public static void validarPartesFormato(FormaW8IMY2015 w8imy) {
		if(!w8imy.isPartIII()) {
	 ...
	 */
	public static void validarDomiciliosBeneficiario(Beneficiario beneficiario) {
	 ...
	 * @param w8imy
	 */
	public static void obtenerTipoBeneficiario(FormaW8IMY2015 w8imy) {
	 ...
	 */
	public static void formaAMayusculas(FormaW8IMY2015 w8imy) {
