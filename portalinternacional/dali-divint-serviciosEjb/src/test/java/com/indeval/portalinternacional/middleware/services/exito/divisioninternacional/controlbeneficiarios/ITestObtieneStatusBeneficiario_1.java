...
public class ITestObtieneStatusBeneficiario_1 extends BaseITestService {
    ...
    *
    */
   public void testObtieneStatusBeneficiario() {
   		log.info("Entrando a testObtieneStatusBeneficiario()");
   		assertNotNull(controlBeneficiariosService);
   		StatusBeneficiario[] statusBeneficiarios = controlBeneficiariosService.obtieneStatusBeneficiario();
   		for(int i=0;i<statusBeneficiarios.length;i++)
   		{
