...
public class ITestSuiteFileTransfer extends BaseITestService {

	/** Objeto de loggeo */
	private final Logger log = LoggerFactory.getLogger(ITestSuiteFileTransfer.class);
	...
	public void testSuite() {
		...
		testSuitePosicionNombrada.addTestSuite(ITestAlmacenaInformacion_1.class);
		testSuitePosicionNombrada.addTestSuite(ITestCancelaProceso_1.class);
		testSuitePosicionNombrada.addTestSuite(ITestGrabaInformacion_1.class);
		testSuitePosicionNombrada.addTestSuite(ITestMuestraInformacion_1.class);
		testSuitePosicionNombrada.addTestSuite(ITestObtieneResumen_1.class);
