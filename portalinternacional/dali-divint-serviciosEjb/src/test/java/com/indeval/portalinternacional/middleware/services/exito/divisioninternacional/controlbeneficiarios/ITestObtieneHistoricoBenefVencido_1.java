...
public class ITestObtieneHistoricoBenefVencido_1 extends BaseITestService {
     ...
     *
     */
    public void testObtieneHistoricoBenefVencido() {
    	log.info("Entrando a testObtieneHistoricoBenefVencido()");
