...
function verNarrativasCapitales(idCalendario){
    ...
    url += '?idCalendario=' + idCalendario + '&origen=false'; 
...
function confirmaEjecutar(){ 
	...
	if(count >0){
		return confirm("Los siguientes "+count+" mensajes ser\u00E1n enviados "+"\u00bfEst\u00E1 de acuerdo?\n"+ids);
	}
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * @param idCalendario
	 */
	function verNarrativasCapitales_popup(idCalendario){		
		var url = contextPath+'/calendarioCapitalesDistribucion/detalleNarrativasCapitales.faces';    
	    url += '?idCalendario=' + idCalendario + '&origen=false'; 
