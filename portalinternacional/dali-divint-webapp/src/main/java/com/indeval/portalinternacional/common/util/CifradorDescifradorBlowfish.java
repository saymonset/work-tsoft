...
public class CifradorDescifradorBlowfish {
     ...
     * Log del Sistema
     */
	private static final Logger log = LoggerFactory.getLogger(CifradorDescifradorBlowfish.class);
    ...
    public CifradorDescifradorBlowfish() throws HashFirmaDigitalException {
        ...
        try {
            ...
            log.error("Ocurrio un error:",nsae);
            ...
            log.error("Ocurrio un error:",nspae);
