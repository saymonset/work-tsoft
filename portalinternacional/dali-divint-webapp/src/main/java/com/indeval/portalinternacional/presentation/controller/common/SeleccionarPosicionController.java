...
/**
 * Controller que atiende las solicitudes de los componentes autocomplete de Cuentas, participantes, emisiones y bovedas
 * 
 * @author Emigdio Hern&aacute;ndez
 * 
 */
@SuppressWarnings({"unchecked"})
public class SeleccionarPosicionController extends ControllerBase {
    ...
    public List<Instrumento> buscarTiposValorPorPrefijo(Object prefijo) {
        ...
        return consultaCatalogoService.buscarTiposDeValoresPorMercados(idMercado.toArray(new Long[] {}), prefijoAjustado);
    ...
    public List<Institucion> buscarParticipante(Object prefijo) {
        ...
        return consultaCatalogoService.findInstitucionesByClaveFolio(prefijoAjustado);
    }
    ...
    public String ejecutarConsulta() {
        ...
        if (institucion != null) {
            ...
            PaginaVO pgTmp = consultaCatalogoService.buscarListaPosicionesNombradasDeParticipante(agente, emision, paginaVO);
            if (pgTmp != null) {
                paginaVO = pgTmp;
