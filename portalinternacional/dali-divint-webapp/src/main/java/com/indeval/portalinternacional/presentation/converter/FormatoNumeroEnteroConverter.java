...
/**
 * Implementación de un {@link Converter} para transformar los valores numricos a cadenas con formato de número entero sin
...
public class FormatoNumeroEnteroConverter implements Converter {
     ...
     *      java.lang.String)
     */
    public Object getAsObject(FacesContext ctx, UIComponent ui, String valor) throws ConverterException {
        Number numero = null;
        try {
     ...
     *      java.lang.Object)
     */
    public String getAsString(FacesContext ctx, UIComponent ui, Object objeto) throws ConverterException {
        String res = null;
