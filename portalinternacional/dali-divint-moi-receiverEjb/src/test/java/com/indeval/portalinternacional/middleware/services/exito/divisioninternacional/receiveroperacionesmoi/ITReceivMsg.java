 ...
 */
package com.indeval.portalinternacional.middleware.services.exito.divisioninternacional.receiveroperacionesmoi;
 ...
 *
 */
public class ITReceivMsg extends BaseITestService {
    ...
    protected void onSetUp() throws Exception {
        super.onSetUp();
        if (receiverOperacionesMoiService == null) {
            receiverOperacionesMoiService = (ReceiverOperacionesMoiService) applicationContext
                    .getBean("receiverOperacionesMoiService");
        }
    }
    
    /**
     * TestCase para probar receiverOperacionesMoiService.receiverMessages();
     */
    public void testReceiverMessage() {
        
        log.info("Entrando a ITestReceiverMessage_1.testReceiverMessage()");
        
        assertNotNull(receiverOperacionesMoiService);
