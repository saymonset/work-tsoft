...
/**
 * Transfer Object que representa el resultado de la Consulta Derechos Beneficiario.
 * 
 * @author Pablo Balderas
 */
public class ConsultaDerechosBeneficiarioTO implements Serializable {

	/** Id para la serialización */
	private static final long serialVersionUID = 755363350254476796L;

	/** Lista con los registros a mostrar en la pantalla */
	private List<DerechoCapitalHistorico> registrosConsulta;
	...
	/**
	 * Método para obtener el atributo registrosConsulta
	 * @return El atributo registrosConsulta
	 */
	public List<DerechoCapitalHistorico> getRegistrosConsulta() {
		return registrosConsulta;
	}

	/**
	 * Método para establecer el atributo registrosConsulta
	 * @param registrosConsulta El valor del atributo registrosConsulta a establecer.
	 */
	public void setRegistrosConsulta(List<DerechoCapitalHistorico> registrosConsulta) {
