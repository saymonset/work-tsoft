...
public class FormatoW8IMY2015 implements Serializable {
	 ...
	 * @param printName
	 */
	public FormatoW8IMY2015(Long idCamposFormato, String camposFormato, String usTIN, String referenceNumber,
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof FormatoW8IMY2015){
        	return ((FormatoW8IMY2015) obj).getIdCamposFormato().compareTo(idCamposFormato)==0;
        } else {
        	return false;
        }
    }
