...
public interface Constantes extends com.indeval.portaldali.middleware.servicios.util.constants.Constantes {
	...
	//static final String PATRON_RFC_SIMPLE = "[A-Z,Ã‘,&]{3,4}[0-9]{2}[0-1][0-9][0-3][0-9]";
	String PATRON_RFC_SIMPLE = "^([A-Z&Ã‘Ã±]{3}|[A-Z][AEIOU][A-Z]{2})\\d{2}((01|03|05|07|08|10|12)(0[1-9]|[12]\\d|3[01])|02(0[1-9]|[12]\\d)|(04|06|09|11)(0[1-9]|[12]\\d|30))([A-Z0-9]{2}[0-9A])?$";
	 ...
	 */
	String ERROR_ISO_DIFERENTE = "EL cï¿½digo Hash del iso generado y del iso firmado en pantalla son diferentes.";
    ...
    /** Constante que define la llave del mapa de datos adicionales para fecha de liquidaciï¿½n */
    String FECHA_LIQ_DA = "fechaLiquidacion";

    /** Constante que define la llave del mapa de datos adicionales para fecha de Operaciï¿½n */
    String FECHA_OP_DA = "fechaOperacion";
    
    /** Constante que define la llave del mapa de datos adicionales para fecha de Notificaciï¿½n */
    ...
    /** Constante que define la llave del mapa de datos adicionales para Descripciï¿½n Contraparte */
    ...
    /** Constante que define la llave del mapa de datos adicionales para el Nï¿½mero de la Cuenta del Depositante */
  ...
  //Altas para comparacion de tope y circulante de fideicomiso
    ...
    String  PATRON_UOI = "[\\-\\_\\/\\.a-zA-ZÀ-ÿ0-9\\\\u00f1\\\\u00d1\\p{Z}´´]+";
	...
	String INSTITUCION_ORIGEN_NULO = "La Instituciï¿½n Origen tiene valor nulo";	
	
	String FORMATO_UOI_INCORRECTO = "UOI con Formato Incorrecto";
	
	String FORMATO_ADP_INCORRECTO = "ADP con Formato Incorrecto";
	 
	String FORMATO_INSTITUCION_ORIGEN_INCORRECTO = "Instituciï¿½n Origen con Formato Incorrecto";	
	...
	String CUSTODIO_INVALIDO = "Custodio invï¿½lido";
	
	String UOI_CON_ADP = "UOI ya cuenta con ADP";
	
	String UOI_NO_AUTORIZADO = "UOI No autorizado";
			
	String UOI_NO_EN_INSTITUCION = "UOI no pertenece a Instituciï¿½n Origen";
	
	String INSTITUCION_ORIGEN_NO_ENCONTRADA = "No existe la instituciï¿½n Origen";
	
	String UOI_YA_CUENTA_CON_INSTITUCION = "UOI ya cuenta con la instituciï¿½n destino";	
