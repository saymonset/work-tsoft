 ...
 *
 */
public class EventoCorporativoFullVistaDTO {
	...
	private List<AtributosEmbebidosEvcoDto> cuerpoEnVistaLista= new ArrayList<AtributosEmbebidosEvcoDto>();
	 ...
	 */
	public List<AtributosEmbebidosEvcoDto> getCuerpoEnVistaLista() {
	...
	public void setCuerpoEnVistaLista(
			List<AtributosEmbebidosEvcoDto> cuerpoEnVistaLista) {
