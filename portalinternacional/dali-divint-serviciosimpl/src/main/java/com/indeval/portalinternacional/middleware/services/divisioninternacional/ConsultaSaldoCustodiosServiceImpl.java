...
public class ConsultaSaldoCustodiosServiceImpl  implements ConsultaSaldoCustodiosService, Constantes {
     ...
     * EmisionDao
     */
    private com.indeval.portaldali.persistence.dao.common.EmisionDao emisionDao = null;
...
//                }
     ...
     * @param emisionDao
     */
    public void setEmisionDao(com.indeval.portaldali.persistence.dao.common.EmisionDao emisionDao) {
    ...
    public void instruyeConciliacion(Long idConciliacion) {
        ...
        op.setOperacion(OperacionesConciliacionInt.TipoOperacionConciliacion.CONCILIA);
    ...
    public void generaReporteAuditoriaConciliacion(Long idConciliacion)
        ...
        OperacionesConciliacionInt op = new OperacionesConciliacionInt();
        op.setOperacion(OperacionesConciliacionInt.TipoOperacionConciliacion.REPORTE_AUDITORIA);
        op.setIdConciliacion(idConciliacion);
