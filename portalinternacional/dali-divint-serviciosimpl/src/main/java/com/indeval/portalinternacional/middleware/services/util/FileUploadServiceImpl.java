...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    /**
     * @see com.indeval.portalinternacional.middleware.services.util.FileUploadService#updateProcessInfo(ProcessInfoVO)
     */
    ...
    private FileUpload parseProcessInfoVO2FileUpload(ProcessInfoVO processInfoVO) {
        log.info("Entrando a FileUploadServiceImpl.parseProcessInfoVO2FileUpload()");
    ...
    private ProcessInfoVO parseFileUpload2ProcessInfoVO(FileUpload fileUpload) {
        log.info("Entrando a FileUploadServiceImpl.parseFileUpload2ProcessInfoVO()");
        if (fileUpload != null) {
