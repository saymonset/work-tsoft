...
import com.indeval.portalinternacional.middleware.servicios.constantes.OpcionesCampo14BENE;
 ...
 *
 */
public class FileTransferCapturaBenefW8BENE2016ServiceImpl extends FileTransferCapturaBenefServiceImpl<FileTransferFormaW8BENE> {
	...
	public FileTransferFormaW8BENE convertRowToFileTransferForma(HSSFRow row) {
		...
		forma.setAnexo7(transformaCadena(getColumnAsString(row.getCell(46))));
		forma.setAnexo8(transformaCadena(getColumnAsString(row.getCell(47))));
		forma.setAnexo9(transformaCadena(getColumnAsString(row.getCell(48))));
		return forma;
	}
	...
	private FormaW8BENE obtenerFormaW8BENE(FileTransferFormaW8BENE fileTransferForma) {
		...
		if(fileTransferForma != null) {
			...
			forma.setFormato(BeneficiariosConstantes.FORMATO_W8_BEN_E_2016);
			...
			/** Se setean valores de anexo **/
			if(obtenerBooleano(fileTransferForma.getCampo14b())){
				obtenerValorCampo14b(forma, fileTransferForma);
			}
	...
	private void obtenerValorCampo5(FormaW8BENE forma, FileTransferFormaW8BENE fileTransferForma) {
		...
		if(OpcionesCampo5BENE.F.toString().equals(fileTransferForma.getCampo5())) {
			...
			if(obtenerBooleano(fileTransferForma.getAnexo3())){
				forma.setPartXIIcmp26ba(Boolean.TRUE);				
			} else if(obtenerBooleano(fileTransferForma.getAnexo4())){
				forma.setPartXIIcmp26bb(Boolean.TRUE);
			}
			
			forma.setPartXIIcmp26c(fileTransferForma.getAnexo5());
			forma.setPartXIIcmp26d(fileTransferForma.getAnexo6());
			forma.setPartXIIcmp26e(fileTransferForma.getAnexo7());
		}
	...
	/**
	 * Obtiene el valor del campo 14.
	 * @param forma Forma donde se va a setear el valor.
	 * @param campo11 Valor en el file transfer.
	 */
	private void obtenerValorCampo14b(FormaW8BENE forma, FileTransferFormaW8BENE fileTransferForma) {
		//Obtiene el valor y lo coloca en la forma
		if(obtenerBooleano(fileTransferForma.getCampo14b())){
			if(OpcionesCampo14BENE.A.toString().equals(fileTransferForma.getAnexo8())){
					forma.setPartIIIcmp14ba(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.B.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bb(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.C.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bc(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.D.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bd(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.E.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14be(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.F.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bf(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.G.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bg(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.H.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bh(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.I.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bi(Boolean.TRUE);
			} else if(OpcionesCampo14BENE.J.toString().equals(fileTransferForma.getAnexo8())){
				forma.setPartIIIcmp14bj(Boolean.TRUE);
				forma.setPartIIIcmp14bk(fileTransferForma.getAnexo9());
			}
		}
	}
