...
public class ConciliacionDivisasIntServiceImplTestMockito {
    ...
    public void getAllByTest() {
        Mockito.when(conciliacionDivisasIntServiceMock.getAllBy(3, -1))
                .thenReturn(getConciliaciones());

        List<ConciliacionDivisasVO> conciliacionDivisasVOS = conciliacionDivisasIntServiceMock.getAllBy(3, -1);
    ...
    private List<ConciliacionDivisasVO> getConciliaciones(){
        ...
        conciliacionDivisasIntVO.setDivisaClaveAlfabetica("USD");
