 ...
 *
 */
public interface PosicionNombradaHDivIntDao extends BaseDao {
	...
	/**
	 * Obtiene el total de posicion disponible correspondiente a las posiciones 
	...
	/**
	 * Realiza la consulta historica de Fideicomisos para el agente y la fecha proporcionados
	 * @param agenteVO
	 * @param fechaConsulta
	 * @return List<Object>
	 */
