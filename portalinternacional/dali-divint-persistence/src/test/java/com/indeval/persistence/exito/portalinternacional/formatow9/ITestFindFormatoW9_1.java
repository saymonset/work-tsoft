package com.indeval.persistence.exito.portalinternacional.formatow9;
...
public class ITestFindFormatoW9_1 extends BaseDaoTestCase {
	
	/**
	 * Log de la clase
	 */
	private static final Logger log = LoggerFactory.getLogger(ITestFindFormatoW9_1.class);
	 ...
	 */
	 ...
	 public void testFindFormatoW9()
	 {
	   ...
	   FormatoW9 formatoW9Prueba= new FormatoW9();
	   formatoW9Prueba.setIdCamposFormatoW9(new Long(1));
	   beneficiario.setFormatoW9(formatoW9Prueba);
