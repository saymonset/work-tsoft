 ...
 *
 */
public class PojoMakerAnnotation extends BaseDaoTestCase {
	
    /* Parametros ajustables */
    
    /* Apunta el dataSorce a Sybase o al de Oracle */
    private static final String DATASOURCE = "dataSourceInternacional";
    
    /* Ajusta el nombre de la tabla a leer */
    private static final String TABLENAME = "C_ERRORES_SWIFT";
   
    /* Ajusta el nombre del paquete donde sera ubicada la entidad */
//    private static final String BASE = "";
    
    /* Ajusta el nombre de la entidad a generar */
    private static final String ENTIDAD = "ErrorSwift";
       
    /* Parametros cliente */
    private static final String ANHIO = "2008";
...
//        String base = BASE;
        ...
        out.println(" */");
        out.println("package com.indeval.portalinternacional.middleware.servicios.modelo;");
        out.println();
        ...
        out.println("public class "+entidad+" implements Serializable {");
        out.println();
        ...
        for(int i = 1; i <= rsmd.getColumnCount(); i++) {
            ...
            out.println("     @Column(name =\""+helper.getColumnName()+"\", unique = false, nullable = "+ helper.isNullable()+ ")");
