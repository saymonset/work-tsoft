package com.indeval.persistence.exito.portalinternacional.statusbeneficiario;
...
public class ITestFindStatusBeneficiario_1 extends BaseDaoTestCase{
	
	/**
	 * Log de la clase
	 */
	private static final Logger log = LoggerFactory.getLogger(ITestFindStatusBeneficiario_1.class);
	...
	public void testFindStatusBeneficiario()
	{
	  ...
	  for(int i=0;i<listStatusBeneficiarios.size();i++)
	  {
	       ...
	       log.debug("statusBeneficiarios [" + ReflectionToStringBuilder.toString(element) + "]");
	  }
