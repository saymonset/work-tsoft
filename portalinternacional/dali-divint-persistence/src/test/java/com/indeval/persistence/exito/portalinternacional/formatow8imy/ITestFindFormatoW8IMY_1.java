package com.indeval.persistence.exito.portalinternacional.formatow8imy;
...
public class ITestFindFormatoW8IMY_1 extends BaseDaoTestCase {
	
	/**
	 * Log de la clase
	 */
	private static final Logger log = LoggerFactory.getLogger(ITestFindFormatoW8IMY_1.class);
	 ...
	 */
	 ...
	 public void testFindFormatoW8IMY()
	 {
	   ...
	   FormatoW8IMY formatoW8IMYPrueba= new FormatoW8IMY();
	   formatoW8IMYPrueba.setIdCamposFormatoW8imy(new Long(1));
	   beneficiario.setFormatoW8IMY(formatoW8IMYPrueba);
