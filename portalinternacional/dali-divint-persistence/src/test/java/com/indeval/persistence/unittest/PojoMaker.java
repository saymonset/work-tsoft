...
public class PojoMaker extends BaseDaoTestCase {
    ...
    private static final String DATASOURCE = "dataSourceOracle";
    
    /* Ajusta el nombre de la tabla a leer */
    private static final String TABLENAME = "ADMINWLES.T_BITACORA_MOS";
    
    /* Ajusta el nombre del paquete donde sera ubicada la entidad */
    private static final String BASE = "efectivo";
    
    /* Ajusta el nombre de la entidad a generar */
    private static final String ENTIDAD = "BitacoraMos";
    ...
    public void testMakePojo() throws Exception {
        ...
        PrintStream out = new PrintStream(new FileOutputStream("pojo.txt"));
        out.println("/*");
        out.println(" * Copyrigth (c) "+ ANHIO +" "+CLIENTE+". All Rights Reserved.");
        out.println(" */");
        out.println("package com.indeval.persistence."+base+".modelo;");
        out.println();
        ...
        out.println(" *   proxy=\"com.indeval.persistence."+base+".modelo."+entidad+"\";");
        out.println(" */");
