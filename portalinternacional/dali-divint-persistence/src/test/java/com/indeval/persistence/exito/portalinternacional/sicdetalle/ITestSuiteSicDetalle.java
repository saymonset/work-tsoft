...
public class ITestSuiteSicDetalle extends BaseDaoTestCase {

	/** Objeto de loggeo */
	private static final Logger log = LoggerFactory.getLogger(ITestSuiteSicDetalle.class);
	...
	public void testSuite() {
		...
		testSuitePosicionNombrada.addTestSuite(ITestFindDepositantes_1.class);
		testSuitePosicionNombrada.addTestSuite(ITestFindSicDetalle_1.class);
